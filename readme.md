★★★★★  大类名和标签名 必须不能重复....比如说有个标签叫aa 你就不能创建一个叫aa 的大类..........
 ★★★★★ 标签里面 不能有 下划线...  不然点击不了标签...



标签里面不能有空格.  有空格就算两个标签了 ...
...
但是... 某类的标签 就要自定义...  大类最多99种...  那就给两位数.    标签呢  大类下... 99个标签也到顶部了....  也给两位数...  然后文章...
某个标签下的文章.. ... 某个大类下的文章 可能有100+  给三位数.

然后 order 设置....  2 2 3  一个7位数的排序... 

标签 也就 100+  那就全部 yml里 自定义??.. 也不是不行...
总比你写在 文件里好吧??? 不然每个文件都写一遍??



比如 css 下有  10+ 标签. 每个标签  前面两位 指定大类. 后面两位指定tag排序??  再然后文件排序的话.... 获取该大类的 前4位. 然后加到 order中???
